...
public:
   ...
   Q_PROPERTY(bool udpOrTcp READ udpOrTcpValue WRITE setudpOrTcpValue NOTIFY remoteValidChanged)

   Q_PROPERTY(bool isChecked READ isCheckedValue NOTIFY checkedChanged)
   Q_PROPERTY(QString tcpIp READ tcpIpValue NOTIFY tcpIpChanged)
   Q_PROPERTY(bool isCheckedTcp READ isCheckedTcpValue NOTIFY checkedTcpChanged)

   bool isCheckedValue() const;

   bool udpOrTcpValue() const;
   bool isCheckedTcpValue() const;
   bool setudpOrTcpValue(bool value) const;
   bool isTrackValue() const;

   QString tcpIpValue() const;

//   bool setTcpIpValue(QString Ip) const;
   ...
   Q_INVOKABLE void isCheckedCenter(bool isChecked);

   Q_INVOKABLE void isCheckedTcpVal(bool isCheckedTcp);
   ...
   Q_INVOKABLE void tcpConnect(QString ip);
//   Q_INVOKABLE void tcpIpChangeValue(QString ip);
signals:
   void checkedChanged(bool isCheck);
   void remoteValidChanged(bool udpOrTcp);
   void modeChanged(void);
   void btnStateChanged(void);
   void valueChanged(void);
   void functionChanged();
   void isTrackChanged(void);
   void tcpIpChanged(QString ip);
   void checkedTcpChanged(bool isCheckTcp);


public slots:
   void _readUdpDatagrams(void);
   void _sysTimerUpdate(void);
   void _udpConnected(void);
   void _tcpLinkTimer(void);
