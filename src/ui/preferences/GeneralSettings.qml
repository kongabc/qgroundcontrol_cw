        ...
        Rectangle{
            ...
            Rectangle{
                ...
                Rectangle{
                    ...
                    anchors.bottomMargin: _margins*6.6
                    visible : QGCCwGimbalController.calibrateStatusCode === 1 ? true : false
                    AnimatedImage{
                        anchors.centerIn: parent
                ...
                Rectangle{
                    ...
                    Text {
                        ...
                        text: QGCCwGimbalController.calibrateStatusCode === 1 ? qsTr("正在校准...") : (QGCCwGimbalController.calibrateStatusCode === 2 ? qsTr("校准成功") : (QGCCwGimbalController.calibrateStatusCode === 3 ? qsTr("校准失败") : qsTr("未开始")))
                    }
                }
                    ...
                    ColumnLayout {
                        ...
                        GridLayout {
                            ...
                            QGCComboBox{
                                ...
                                model:  [
                                    qsTr("Video Stream Disabled"),
                                    qsTr("Video Stream")
                                ]
                                visible: videoStreamLabel.visible
                                currentIndex:  (!_videoAutoStreamConfig && (_isUDP264 || _isUDP265 || _isMPEGTS) && _videoSettings.udpPort.visible) ? 1 : 0 //  QGroundControl.videoManager.selectIndex
                                onActivated:{

                                    QGroundControl.videoManager.selectIndexFun(index);
                                    if(index === 0){
                                        QGroundControl.settingsManager.videoSettings.selectVideoSource("Video Stream Disabled");
                                    }else{
                                        //默认先选择H264
                            ...
                            QGCLabel {
                                ...
                                visible:    !_videoAutoStreamConfig && videoCombo.currentIndex === 1
                            }
                            QGCTextField{
                                id:inputStr
                                Layout.preferredWidth:  _comboFieldWidth
                                ...
                                onEditingFinished:{
                                    //流地址传给c文件
                                    //                                        QGroundControl.videoManager._allVideoStreamSlots(text);
                            ...
                            QGCLabel {
                                id:         videoSourceLabel
                                text:       qsTr("Source")
                                visible:    false //!_videoAutoStreamConfig && _videoSettings.videoSource.visible
                            }
                            FactComboBox {
                                id:                     videoSource
                                Layout.preferredWidth:  _comboFieldWidth
                            ...
                            QGCLabel {
                                id:         udpPortLabel
                                text:       qsTr("UDP Port")
                                visible:   false //  !_videoAutoStreamConfig && (_isUDP264 || _isUDP265 || _isMPEGTS) && _videoSettings.udpPort.visible
                            }
                            FactTextField {
                                Layout.preferredWidth:  _comboFieldWidth
                            ...
                            QGCLabel {
                                ...
                                visible:    _showSaveVideoSettings && _videoSettings.maxVideoSize.visible && _videoSettings.enableStorageLimit.value && videoUrlLabel.visible // new add 2024
                            }
                            FactTextField {
                                Layout.preferredWidth:  _comboFieldWidth
                            ...
                            FactCheckBox {
                                ...
                                visible:    !_videoAutoStreamConfig && _isGst && fact.visible && videoUrlLabel.visible //new add 2024
                            }
                            ...
                            FactCheckBox {
                                ...
                                visible:    _showSaveVideoSettings && fact.visible && videoUrlLabel.visible //new add 2024
                            }
                ...
                Rectangle{
                    ...
                    ColumnLayout{
                        ...
                        RowLayout{
                            ...
                            Layout.preferredHeight: _margins*4
                            Text {
                                id: name
                        ...
                        RowLayout{
                            ...
                            QGCButton {
                                ...
                                onClicked:  {
                                    bgBox.visible = true
                                    if(QGCCwGimbalController.calibrateStatusCode !== 2){
